...
public class RobotUtil {
	 ...
	 * @param targetDistance The distance in meters to move
	...
	/**
	 * Helper method for case where min and max are same number but one has a negative sign
	 ...
	 * @param power The power to move at. If it is 0 then it will turn in place
	 * @param currentAngle Current robot angle
	 * @param targetAngle Target angle to move to
	 * @param kP How fast to get to target. The P term in PID
